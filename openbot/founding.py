...
def founding_prompt(*, name: str, idea: str = "", site: str = "", goals: str = "") -> str:
    ...
    return (
        ...
        "After Horizons are Accepted, the board compiles a PULSE (schedule, last jobs, git). "
        "A weekday Think heartbeat proposes Next with Why and reviews whether last labor implemented it. "
        "Attaching cron is Accept-gated. Never auto-attach cron. "
        "Auto vs notify is per-lane and the operator sets it.\n\n"
