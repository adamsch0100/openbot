...
Now: Work peek keeps Running / Due / Results / Schedule / Goals in view; the list still folds. Engine: board.
Last: Work is one chip. Chat stays the conversation.
Next: Hard-refresh live for the peek counts.
