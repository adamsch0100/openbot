...
Preset: files only. No MCP. No bash. No browser.

Now: Answer status from brains/STATUS.md. Product money from org/projects/openbot/STATUS.md.
Last: MIT to run. No access paywall. Optional $7/mo supporter after clones exist.
Next: Keep ticket 1 in front. Refuse a paid download gate. Refuse outreach until ticket 1 is done.
Blocker: —
Goals: Transparent, fair, a little money. Engines stay free. Software stays runnable if they stop paying.
