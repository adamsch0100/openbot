...
class ReadyTests(unittest.TestCase):
    ...
    def test_credit_and_assets(self):
        ...
        self.assertIn("app.js?v=116", html)
        self.assertIn("styles.css?v=116", html)
        self.assertIn("calm phone work lane", (ROOT / "web" / "styles.css").read_text(encoding="utf-8"))
        ...
        self.assertIn("Other jobs on this CEO wait", js)
        ...
        self.assertIn("Retry on live Hermes", js)
