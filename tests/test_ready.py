...
class ReadyTests(unittest.TestCase):
    ...
    def test_credit_and_assets(self):
        ...
        self.assertIn("styles.css?v=197", html)
        self.assertIn("activity-sheet", html)
        self.assertIn("route-hatch", html)
        self.assertIn("id=\"closeActivity\"", html)
        css = (ROOT / "web" / "styles.css").read_text(encoding="utf-8")
        self.assertIn("position: sticky", css)
        self.assertIn("calm phone: CEO name in head; Work ribbon above composer", css)
        self.assertIn("work-ribbon", html)
        self.assertIn("id=\"chatDock\"", html)
        self.assertIn("id=\"workFailed\"", html)
        self.assertIn("today-brief", css)
        self.assertIn("function mountTodayBrief", js)
        ...
        self.assertIn("What’s going on", html)
        self.assertIn("Desk status", html)
        self.assertIn("function statusFieldsHtml", js)
        self.assertIn("Working on", js)
        self.assertIn("Just did", js)
        ...
        self.assertIn("data-work=\"goals\"", html)
        self.assertIn("function cronIsLive", js)
        self.assertIn("Running now on this CEO.", js)
        ...
        self.assertGreaterEqual(html.count('data-work="doing"'), 1)
        self.assertIn("id=\"workToggle\"", html)
        self.assertIn("function pickDefaultWorkView", js)
        ...
        self.assertIn("city-audit-batch-4", js)
        self.assertNotIn("conversion-surge|competitor-content-watch|city-audit-batch-4", js)
