...
class ReadyTests(unittest.TestCase):
    ...
    def test_credit_and_assets(self):
        ...
        self.assertIn("app.js?v=126", html)
        ...
        self.assertIn("function closeOrgRail", js)
        self.assertIn("function paintAddCeoControls", js)
        self.assertIn("function addCeoFormHtml", js)
        self.assertIn("function ceoSeatPreset", js)
        self.assertIn("menuCeoSite", js)
        self.assertIn("menuCeoRepo", js)
        self.assertIn("menuCeoRailway", js)
        self.assertIn("menuCeoAuthGithub", js)
        self.assertIn("pmill.ai", js)
        self.assertIn("adamsch0100/pmillsports", js)
        self.assertIn("victorious-presence", js)
        org_py = (ROOT / "openbot" / "org.py").read_text(encoding="utf-8")
        self.assertIn("CEO_SEAT_PRESETS", org_py)
        self.assertIn("seat_preset_for_name", org_py)
        self.assertIn("github_repo", org_py)
        self.assertIn("github_repo", server)
        self.assertIn('hatch.hidden = !forced', js)
        self.assertIn("node-menu.ceo-add", css)
