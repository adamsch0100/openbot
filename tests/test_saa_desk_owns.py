...
class SaaDeskOwnsTests(unittest.TestCase):
    def test_markers(self):
        ...
        self.assertIn("6f8b4dcf42e2", hermes)
        ...
        self.assertIn("_ensure_hands_off", launch)
        self.assertIn("_heartbeat_already_on", launch)
        self.assertIn("HANDS_OFF_CEO_IDS", org)
        self.assertIn("def pause_imported_crons_once", hermes)
        self.assertIn("def folder_can_code", org)
