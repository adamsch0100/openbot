...
class RouterClassifyTests(unittest.TestCase):
    def test_status_and_code(self):
        ...
        self.assertEqual(classify("Do we need to remake any crown?"), "cos")
        self.assertEqual(classify("Not sure what db you need"), "cos")
    ...
    def test_route_plan_chains_and_think(self):
        ...
        self.assertIn("OttoBot", hello)
        self.assertIn("report to Cos", hello)
        ...
        self.assertIn("OttoBot", thanks)
        self.assertIn("Cos", thanks)
        ...
        remake = status_reply(index, "Do we need to remake any crown?", "Cos")
        self.assertIn("ticket 1", remake)
        self.assertIn("Up next: folder then diff", remake)
        self.assertNotIn("secret dump", remake)
...
class BrandMarkTests(unittest.TestCase):
    def test_lockup_is_on_the_board(self):
        ...
        self.assertIn(">Tools</button>", html)
        ...
        self.assertIn("Board — status (free)", js)
        ...
        self.assertIn("What’s going on", js)
        css = (root / "web" / "styles.css").read_text(encoding="utf-8")
        self.assertIn("bubble-work", css)
